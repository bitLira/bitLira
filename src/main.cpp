...
uint256 hashGenesisBlock("0x88a39748ec693126d14200d5c51e1f9793a9391f29051cac26f645a01a5fa2a8");
...
const string strMessageMagic = "BitLira Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // BitLira: 7 days
static const int64 nTargetSpacing = 120; // BitLira: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bitlira miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitLira", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1391357922; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 224006;

        if (fTestNet)
        {
            block.nTime    = 1391357922;
            block.nNonce   = 224006;
        }
